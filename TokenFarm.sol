...
// Import contracts for both CFP and SWT tokens.
import "./CoinfproToken.sol";
import "./SolidWasteToken.sol";


contract TokenFarm {
    string public name = "SolidWaste Token Farm";
    SolidWasteToken public solidWasteToken;
    CoinfproToken public coinfproToken;
    ...
    constructor (CoinfproToken _CoinfproToken, SolidWasteToken _SolidWasteToken) public{
        coinfproToken = _CoinfproToken;
        solidWasteToken = _SolidWasteToken;
        owner = msg.sender; // address of the owner of the contract
    }
    
    /// @param _amount refers to the amount of the tokens you want to stake.
    function stakeToken(uint _amount) public {
        ...
        coinfproToken.transferFrom(msg.sender, address(this), _amount); 
    ...
    function unstakeToken() public {
        ...
        coinfproToken.transfer(msg.sender,balance);
    ...
    function issuesToken() public {
        ...
        for(uint i=0; i<staker.length;i++){
            ...
            if(isStaking[recipient] == true){
                ...
                solidWasteToken.transfer(recipient, balance);
            }
        }
    }
